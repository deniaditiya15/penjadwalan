...
<div class="container">
    <!-- Judul -->
    <h1 class="mb-4 fw-bold text-start text-secondary">Tambah Kelas</h1>
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header text-white fw-semibold rounded-top" style="background-color: #465C88;">
            <i class="bi bi-building-add"></i> Form Tambah Kelas
        </div>
        <div class="card-body">
                ...
                <table class="table table-borderless align-middle mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control rounded-pill bg-white" name="kelas" value="{{ old('kelas') }}"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control rounded-pill bg-white" name="nama_walikelas" value="{{ old('nama_walikelas') }}"></td>
                        </tr>
                        <tr>
                            <th class="bg-light text-center fw-semibold">Jumlah Siswa</th>
                            <td><input type="number" class="form-control rounded-pill bg-white" name="jumlah_siswa" value="{{ old('jumlah_siswa') }}"></td>
                        </tr>
                    </tbody>
                </table>
